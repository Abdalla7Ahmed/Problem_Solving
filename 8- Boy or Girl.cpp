...
"she" is actually a very strong man! Our hero is very sad and he is too
tired to love again now. So he came up with a way to recognize users' genders
by their user names.
...
int main()
{
    ...
    {
        Name[i] -=96;
        if( (temp[Name[i]+1] & Name[i]) == Name[i]) continue;
